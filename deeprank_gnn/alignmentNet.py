...
class GNN_layer(nn.Module):
    ...
    def update_nodes(self, edges, edge_attr, hidden_features, steps=1):
        ...
        # It is possible to run input through the same same layer multiple times
...
class SuperGNN(nn.Module):
    ...
    # Runs data through layers and return output. Potentially, attention can also be returned 
...
class Alignment_GNN(SuperGNN):
    def __init__(self, nmb_edge_attr, nmb_node_attr, nmb_output_features, 
        ...
        super(Alignment_GNN, self).__init__(nmb_edge_attr, nmb_node_attr, 
...
if __name__ == '__main__':
    ...
    gnn = Alignment_GNN(nmb_edge_attr=NMB_EDGE_ATTIBUTES, nmb_node_attr=NMB_NODE_ATTRIBUTES, 
