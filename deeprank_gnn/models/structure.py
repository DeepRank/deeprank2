...
class Atom:
    ...
    def __init__(self, residue, name: str, element: AtomicElement, position: numpy.array, occupancy: float):
        """
            Args:
...
class Residue:
    ...
    def __init__(self, chain, number: int, amino_acid: AminoAcid = None, insertion_code: str = None):
        """
        Args:
...
class Chain:
    ...
    def __init__(self, model, id_: str):
        """
        Args:
