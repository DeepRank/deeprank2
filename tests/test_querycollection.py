...
def _querycollection_tester(
    ...
    Args:
        query_type: query type to be generated. It accepts only 'ppi' (ProteinProteinInterface) or 'srv' (SingleResidueVariant).
        n_queries: number of queries to be generated. Defaults to 3.
        ...
        cpu_count: number of cpus to be used during the queries processing. Defaults to 1.
...
def _assert_correct_modules(
    ...
    Args:
        output_paths: output_paths as returned from _querycollection_tester.
        features: feature(s) that should be present.
        absent: feature that should be absent.
    """
