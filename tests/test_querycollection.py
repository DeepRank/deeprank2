...
def ppi_querycollection_tester(n_queries = 10, feature_modules = None, cpu_count = 1, combine_output = True):
    """
    Generic function to test QueryCollection class.
...
def test_querycollection_process():
    ...
    for querytest in [variant_querycollection_tester, ppi_querycollection_tester]:
        n_queries = 5

        collection, output_directory, _ = querytest(n_queries)
...
def test_querycollection_process_single_feature_module():
    ...
    for querytest in [variant_querycollection_tester, ppi_querycollection_tester]:
        ...
        _, output_directory, _ = querytest(feature_modules = feature_modules)
        rmtree(output_directory)
...
def test_querycollection_process_all_features_modules():
    ...
    for querytest in [variant_querycollection_tester, ppi_querycollection_tester]:
        ...
        _, output_directory, _ = querytest()
...
def test_querycollection_process_combine_output_true():
    ...
    for querytest in [variant_querycollection_tester, ppi_querycollection_tester]:
        ...
        _, output_directory_t, output_paths_t = querytest()

        _, output_directory_f, output_paths_f = querytest(combine_output = False)
...
def test_querycollection_process_combine_output_false():
    ...
    for querytest in [variant_querycollection_tester, ppi_querycollection_tester]:
        ...
        collection, output_directory, output_paths = querytest(cpu_count = cpu_count, combine_output = combine_output)
