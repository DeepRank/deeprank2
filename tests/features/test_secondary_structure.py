...
from deeprank2.features.secondary_structure import (
    SecondarySctructure,
...
def test_secondary_structure_atom() -> None:
    ...
    for node in node_info_list:
        dssp_line = next(line for line in dssp_lines if (line[5:10] == str(node[0]).rjust(5) and line[11] == node[1]))
