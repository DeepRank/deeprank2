...
class TestOutputExporters(unittest.TestCase):
    ...
    def test_scatter_plot(self):
        ...
        with scatterplot_exporter:
            scatterplot_exporter.process("train", epoch_number, ["entry1", "entry1", "entry2"], [0.1, 0.65, 0.98], [0.0, 0.5, 1.0], 0.1)

            scatterplot_exporter.process("valid", epoch_number, ["entryA", "entryB", "entryC"], [0.3, 0.35, 0.25], [0.0, 0.5, 1.0], 0.1)
