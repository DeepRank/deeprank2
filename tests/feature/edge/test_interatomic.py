...
def test_add_features():
    ...
    add_features(pdb_path, [edge_close])
    ...
    add_features(pdb_path, [edge_far])
    ...
    add_features(pdb_path, [edge_intermediate])
    ...
    add_features(pdb_path, [close_attracting_edge])
    ...
    add_features(pdb_path, [far_attracting_edge])
