...
def test_add_features():
    ...
    add_features(pdb_path, _wrap_in_graph(edge_close))
    ...
    add_features(pdb_path, _wrap_in_graph(edge_far))
    ...
    add_features(pdb_path, _wrap_in_graph(edge_intermediate))
    ...
    add_features(pdb_path, _wrap_in_graph(close_attracting_edge))
    ...
    add_features(pdb_path, _wrap_in_graph(far_attracting_edge))
    ...
    add_features(pdb_path, _wrap_in_graph(opposing_edge))
    ...
    edge = Edge(contact)
    add_features(pdb_path, _wrap_in_graph(edge))
