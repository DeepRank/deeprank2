...
| SRVs | `components`, `contact`, `exposure`, `irc`, `secondary_structure`, `surfacearea`, 26 features in total.                        | Same as above for `conservation`. | graph only: **1.82** (std 0.37)  graph + grid: **2.58** (std 0.66) | graph only: **0.05** (std 0.01) graph + grid: **8.52** (std 8.50) |
