...
- [DeeprankCore](#deeprankcore)
  ...
  - [Installation](#installation)
    ...
    - [DeeprankCore Package](#deeprankcore-package)
 ...
 * For MacOS with M1 chip users only: see [this](https://stackoverflow.com/questions/30145751/python3-cant-find-and-import-pyqt5) solution if you run into problems with PyQt5 during deeprankcore installation.
