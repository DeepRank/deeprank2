...
class Grid:
    ...
    def _get_mapped_feature_gaussian(self, position: np.ndarray, value: float) -> np.ndarray:
        beta = 1.0
    ...
    def _get_mapped_feature_fast_gaussian(self, position: np.ndarray, value: float) -> np.ndarray:
        beta = 1.0
        cutoff = 5.0 * beta
    ...
    def _get_mapped_feature_bsp_line(self, position: np.ndarray, value: float) -> np.ndarray:
        order = 4
