...
alanine = AminoAcid(
    "Alanine", "ALA", "A", charge=0, polarity=Polarity.NONPOLAR, size=1, mass=71.1, pI=6.00, hydrogen_bond_donors=0, hydrogen_bond_acceptors=0, index=0
)
...
aspartate = AminoAcid(
    "Aspartate", "ASP", "D", charge=-1, polarity=Polarity.NEGATIVE, size=4, mass=115.1, pI=2.77, hydrogen_bond_donors=0, hydrogen_bond_acceptors=4, index=2
)

glutamate = AminoAcid(
    "Glutamate", "GLU", "E", charge=-1, polarity=Polarity.NEGATIVE, size=5, mass=129.1, pI=3.22, hydrogen_bond_donors=0, hydrogen_bond_acceptors=4, index=3
)

phenylalanine = AminoAcid(
    "Phenylalanine", "PHE", "F", charge=0, polarity=Polarity.NONPOLAR, size=7, mass=147.2, pI=5.48, hydrogen_bond_donors=0, hydrogen_bond_acceptors=0, index=4
)
...
isoleucine = AminoAcid(
    "Isoleucine", "ILE", "I", charge=0, polarity=Polarity.NONPOLAR, size=4, mass=113.2, pI=6.02, hydrogen_bond_donors=0, hydrogen_bond_acceptors=0, index=7
)
...
leucine = AminoAcid(
    "Leucine", "LEU", "L", charge=0, polarity=Polarity.NONPOLAR, size=4, mass=113.2, pI=5.98, hydrogen_bond_donors=0, hydrogen_bond_acceptors=0, index=9
)

methionine = AminoAcid(
    "Methionine", "MET", "M", charge=0, polarity=Polarity.NONPOLAR, size=4, mass=131.2, pI=5.74, hydrogen_bond_donors=0, hydrogen_bond_acceptors=0, index=10
)

asparagine = AminoAcid(
    "Asparagine", "ASN", "N", charge=0, polarity=Polarity.POLAR, size=4, mass=114.1, pI=5.41, hydrogen_bond_donors=2, hydrogen_bond_acceptors=2, index=11
)

proline = AminoAcid(
    "Proline", "PRO", "P", charge=0, polarity=Polarity.NONPOLAR, size=3, mass=97.1, pI=6.30, hydrogen_bond_donors=0, hydrogen_bond_acceptors=0, index=12
)

glutamine = AminoAcid(
    "Glutamine", "GLN", "Q", charge=0, polarity=Polarity.POLAR, size=5, mass=128.1, pI=5.65, hydrogen_bond_donors=2, hydrogen_bond_acceptors=2, index=13
)

arginine = AminoAcid(
    "Arginine", "ARG", "R", charge=1, polarity=Polarity.POSITIVE, size=7, mass=156.2, pI=10.76, hydrogen_bond_donors=5, hydrogen_bond_acceptors=0, index=14
)

serine = AminoAcid(
    "Serine", "SER", "S", charge=0, polarity=Polarity.POLAR, size=2, mass=87.1, pI=5.68, hydrogen_bond_donors=1, hydrogen_bond_acceptors=2, index=15
)
...
valine = AminoAcid(
    "Valine", "VAL", "V", charge=0, polarity=Polarity.NONPOLAR, size=3, mass=99.1, pI=5.96, hydrogen_bond_donors=0, hydrogen_bond_acceptors=0, index=17
)
