...
DeepRank-Core allows to transform and store 3D representations of both PPIs and individual proteins' variants into 3D grids or graphs containing geometric and physico-chemical information, and provides a DL pipeline which can be used for training pre-implemented neural networks for whatever specific pattern of interest for the user.
