...
def add_features(pdb_path: str, graph: Graph, *args, **kwargs): # pylint: disable=unused-argument
    for edge in graph.edges:
        ...
        interatomic_electrostatic_potentials = get_coulomb_potentials_new(atoms1, atoms2)
        interatomic_vanderwaals_potentials = get_lennard_jones_potentials_new(atoms1, atoms2)
