    ...
    def process( # pylint: disable=too-many-arguments, too-many-locals
        ...
        Args:
            ...
            feature_modules (Optional[Union[ModuleType, List[ModuleType], str, List[str]]], optional): Features' module or list of features' modules
                ...
                Use 'all' to include all feature modules.
                If set to None or 'all', all available modules in `deeprankcore.features` are used to generate the features.
                Defaults to None, which will only use the basic feature modules deeprankcore.features.components and deeprankcore.features.contact.
