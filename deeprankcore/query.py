...
class QueryCollection:
    ...
    def process( # pylint: disable=too-many-arguments, too-many-locals
        ...
        Args:
            ...
            combine_output (Optional[bool], optional): For combining the .HDF5 files generated by the processes. Defaults to True.
...
class SingleResidueVariantResidueQuery(Query):
    ...
    def __init__(  # pylint: disable=too-many-arguments
        ...
        Args:
            ...
            radius (Optional[float], optional): In Ångström, determines how many residues will be included in the graph. Defaults to 10.0.
...
class SingleResidueVariantAtomicQuery(Query):
    ...
    def _get_atom_node_key(atom) -> str:
       """Since pickle has problems serializing the graph when the nodes are atoms, this function can be used to generate a unique key for the atom."""
